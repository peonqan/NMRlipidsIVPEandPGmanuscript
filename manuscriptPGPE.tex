...
\begin{figure}[!h]
  \centering
  \includegraphics[width=9.0cm]{../Figs/struct.png}
...
\begin{figure*}[]
  ...
  \todo{Data for CHARMM, Lipid17, Slipids, and also GROMOS also without ions is now available.
    This data should be updated into this plot}
