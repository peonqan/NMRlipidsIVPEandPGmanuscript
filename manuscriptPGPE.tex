...
Larger barriers for crossings between \textit{gauche} and \textit{trans} states were observed for
the last dihedral in PS and PG than for PC and PE lipids. 
Rest of the dihedrals are similar between different lipids,
with the exception of PS lipids for which slightly larger energy for ecplised anti conformation next to phosphate group
was observed.
