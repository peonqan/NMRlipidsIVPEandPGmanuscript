...
The conformational ensembles of different lipid headgroups and their order parameters have been
discussed previously \cite{??}, but these studies have been inconclusive because order parameter
signs have been unknown and tools to interpret the conformational ensembles have not been available.
Our experimental order parameters witht the information of the sign from different lipid headgroups
...
While headgroup order parameters of PC and PE lipids are rather similar,
PG and PS lipids exhibit distinct values compared with other lipids.
In PS lipids, the $\alpha$-carbon order parameter exhibits significant forking and
the $\beta$-carbon order parameter is more negative than others.
The $\alpha$-carbon order parameter of PG is similar to PE and PG, while the positive value of $\beta$-carbon
is distinct from the other lipids.
...
\begin{figure}[]
  ...
  \caption{\label{DIHSwithCA}
    Changes in CHARMM36 dihedrals with increasing amount of CaCl$_2$.
  }
\end{figure}
