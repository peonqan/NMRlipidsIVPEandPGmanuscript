...
not within the experimental error bars, it captures the essential differences between different headroups
with the exception of $\beta$-carbon order parameter of PC (Fig.~\ref{structures}),
which is too large when compared with PS or PE order parameter, or with experiments \cite{botan15}.
As already pointed out in our previous study \cite{antila19}, N-C$_\beta$-C$_\alpha$-O$_\alpha$
dihedral exhibits a more asymmetric angle distribution for PS, having largest probability being
in gauche 270$^\degree$ conformation, than for the PC headgroup.
Also C$_\beta$-C$_\alpha$-O$_\alpha$-P in PS has asymmetric tendency to be in this conformation.
In PG, O$_\beta$-C$_\beta$-C$_\alpha$-O$_\alpha$ dihedral (corresponding N-C$_\beta$-C$_\alpha$-O$_\alpha$ dihedral in other lipids)
is mostly in trans conformation, and C$_\beta$-C$_\alpha$-O$_\alpha$-P  has asymmetric tendency to be in
gauche 60$^\degree$ conformation. 
