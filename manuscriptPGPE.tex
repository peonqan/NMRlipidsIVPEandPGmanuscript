...
\affiliation{Laboratoire Coopératif "Lipotoxicity and Channelopathies – ConicMeds", Université de Poitiers, 1 rue Georges Bonnet, 86000 Poitiers, Franc }
...
Only structures from X-ray and Cryo-EM with a resolution higher than 3.2~\AA were used in the analysis.
Lipids from same PDB identifier with all dihedrals angles within 3 degrees were discarded from the analysis
to avoid overweighting of lipid structures present, \textit{e.g.}, due to rotational symmetries.
...
In conclusion, all studied lipid headgroups sample very broad conformational ensembles in liquid lamellar phase and the sampled dihedral angles are within approximately same ranges for all headgroup types. % (Fig. \ref{structures}).
...
decrease the abundance of \textit{trans} states in g$_2$-g$_3$-O$_{g_3}$-P and g$_3$-O$_{g_3}$-P-O$_\alpha$
dihedrals.
...
Additionally, the binding of ions to membranes may affect the lipid headgroup conformational ensembles in physiological conditions.
The binding of Ca$^{2+}$ ions to a PC headgroup leads to a similar decrease in the \textit{trans} state probability for g$_3$-O$_{g3}$-P-O$_\alpha$ dihedral
...
to complement the data in PDB in revealing how complex systems made up of disordered biomolecules behave.
