...
In conclusion, all lipid headgroups sample very broad conformational ensembles in the liquid lamellar phase and the sampled dihedral angles are within approximately same ranges for all headgroup types. % (Fig. \ref{structures}).
...
decreases the abundance of trans states in g$_2$-g$_3$-O$_{g_3}$-P and g$_3$-O$_{g_3}$-P-O$_\alpha$
dihedrals.
The choline region remains essentially unchanged and only minor changes are observed in other dihedrals even though almost half of the molecules in the membrane are cationic surfactants. 
...
to complement the data in the PDB for elucidating how complex systems containing disordered biomolecules behave.
