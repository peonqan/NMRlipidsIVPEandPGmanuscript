  ...
  \begin{minipage}[t]{\textwidth}
    \begin{tabular}{l c c r r r r r r c c}
     ...
     \hline
      ...
      POPC:POPG (7:3)        & Slipid \cite{??}        & 0         & 0  & 350:150 & 25000 & 0   &  310  & 500 & 100 & \cite{slipidPOPC70POPG30T310K} \\
      POPC:POPG (1:1)        & Slipid \cite{??}        & 0         & 0  & 128:128 & 12800 & 0   &  298  & 500 & 400 & \cite{slipidPOPC50POPG50T298K} \\
      POPC:POPG (1:1)        & Slipid \cite{??}        & 0         & 0.1  & 128:128 & 12800 & 23  &  298  & 500 & 400 & \cite{slipidPOPC50POPG50T298K} \\
      POPC:POPG (1:1)        & Slipid \cite{??}        & 0         & 0.2  & 128:128 & 12800 & 46  &  298  & 1500 & 500 & \cite{slipidPOPC50POPG50T298K} \\
      POPC:POPG (1:1)        & Slipid \cite{??}        & 0         & 0.5  & 128:128 & 12800 & 115 &  298  & 1500 & 500 & \cite{slipidPOPC50POPG50T298K} \\
      POPC:POPG (1:1)        & Slipid \cite{??}        & 0         & 1.0  & 128:128 & 12800 & 230 &  298  & 1500 & 500 & \cite{slipidPOPC50POPG50T298K} \\
      
      \hline
      POPC:POPG (4:1)        & Lipid17 \cite{??}       &0          & 0  & 350:88 & 26265 & 0  &  298  & 400 & 350 & \cite{Lipid17POPCPOPG8020} \\
      POPC:POPG (4:1)        & Lipid17 \cite{??}       &0          & 0.1& 350:88 & 26124 & 47 &  298  & 400 & 150 & \cite{Lipid17POPCPOPG8020100mMCaCl} \\
      POPC:POPG (4:1)        & Lipid17 \cite{??}       &0          & 1.0& 350:88 & 24840 & 475 &  298  & 1200 & 200 & \cite{Lipid17POPCPOPG80201000mMCaCl} \\
      POPC:POPG (1:1)        & Lipid17 \cite{??}       &0          & 0  & 150:150 & 31572 & 0  &  298  & 320 & 200 & \cite{Lipid17POPCPOPG5050} \\
      POPC:POPG (1:1)        & Lipid17 \cite{??}       &0          & 0.1& 150:150 & 31401 & 57 &  298  & 720 & 198 & \cite{Lipid17POPCPOPG5050100mMCaCl} \\
      POPC:POPG (1:1)        & Lipid17 \cite{??}       &0          & 1.0& 150:150 & 29865 & 569 &  298  & 720 & 200 & \cite{Lipid17POPCPOPG50501000mMCaCl} \\
      \hline
...
To evaluate calcium binding to PG containing lipid bilayers in simulations,
we calculated the changes in headgroup order parameters upon addition of CaCl$_2$
to POPC:POPG (1:1) and (4:1) mixtures for which experimental data is available \cite{borle85,macdonald87}.
The headgroup order parameters of PC lipids can be used to measure the ion binding
affinity to lipid bilayers and evaluate MD simulations against experimental data,
because their magnitude is linearly proportional to the amount of bound charge in bilayer
and order parameters can be directly calculated from MD simulations \cite{seelig87,catte16}.
...
As previously observed for PC and PS lipids, the decrease in PC headgroup order parameters with
increasing CaCl$_2$ concentration is overestimated in Slipids and Lipid17 simulations (Figs. \ref{changesWITHCaClPG} and \ref{changesWITHCaClPG1PC4})
indicating too strong binding affinity of calcium into the bilayers.
...
The behaviour of $\beta$-carbon order parameter of POPG is similar to POPC upon addition of calcium in experiments,
exhibiting a rapid decrease with CaCl$_2$ concentrations below 10 mM,
and then a more modest decrease with larger concentrations (Fig. \ref{changesWITHCaClPG}) \cite{borle85}.
...
\todo{To be finished once we have the new CHARMM simulations.} For the response of PG $\alpha$-carbon order parameters to CaCl$_2$,
different force fields give different predictions, but experimental data to evaluate these predictions is not available. 
