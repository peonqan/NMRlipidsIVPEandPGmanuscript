...
reproducing the experimental lipid headgroup and glycerol backbone order parameters in different lipids,
see Refs. \cite{botan15} and \cite{antila19}, and Figs. \ref{HGorderParametersPE} and \ref{HGorderParametersPOPG}.
