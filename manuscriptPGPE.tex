...
\subsection{Counterion binding to PE and PG lipid bilayers}
...
Experimental data for sodium binding to PE lipids is not available, but
large deviations from PC would be surprising.
However, in Slipids and GROMOS-CKP simulations, the binding affinity to POPE is much weaker than to POPC
(our previous work \cite{catte16} and Fig. ??). On the other hand, 
the sodium binding affinity is stronger to POPE in Lipid17 simulations than to POPC in simulations with
