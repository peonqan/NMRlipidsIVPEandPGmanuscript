...
\subsection{Lipid headgroup interactions in PC:PE and PC:PG mixtures and counterion binding}
\begin{figure*}[]
  \centering
...
overestimated upon addition of PE and underestimated upon addition of PG.
...
of Berger force field to cholesterol was significantly overestimated \cite{botan15}.
...
In our previous study about PS lipids \cite{antila18}, we related the underestimated increase of PC
headgroup order parameters upon addition of negaticely charged lipids
%was previously interepreted
...
Lipid 17 simulation exhibits the stronger counter-ion binding affinitiy to the pure POPG bilayer (Fig. \ref{CIdensPG})
and larger decrease in POPC $\beta$ carbon order parameter upon addition of POPG than other simulations.
This, together with the low area per molecule in Lipid17 (59.5 {\AA} vs. 66.1 {\AA} in experiments) suggests
that the counterion binding this model is too strong.
However, $\beta$-carbon order parameter of POPC in GROMOS-CKP simulations is in line with experiments and
increases more than in CHARMM36 and Slipids simulations even though the binding affinities in these
simulations are simialar. On the other hand, the different responses of different hydrogens in $\alpha$-carbons
...
\begin{figure}[]
  ...
  \todo{Data for GROMOS is also available without ions, but I could not analyze it, probably because tpr file was not correct.}
\end{figure}
