...
or (\texttt{scratch/opAAUA\_prod.py}) in  Ref.~\citenum{MATCHgit}, and the order parameters were
...
phopholipids, PC, PE, PG and PS, sample a wide range of different conformations in the lamellar liquid state.
