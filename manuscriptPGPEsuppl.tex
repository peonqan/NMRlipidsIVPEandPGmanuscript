...
\affiliation{CIQUP, Centro de Investigação em Qu\'{i}mica, Departamento de Qu\'{i}mica e Bioqu\'{i}mica, Faculdade de Ciências, Universidade do Porto, Porto, Portugal}
...
\begin{figure}[]
%  \centering
  \includegraphics[width=\textwidth]{./Figs/POPE_SI.pdf}
  \caption{\label{POPEspectra}
    ...
    (C) Headgroup and glycerol backbone R-PDLF dipolar slices. The arrows indicate the splittings used to determine the C--H bond order parameters by using  $|S_{\rm{CH}}|=\Delta\nu/0.315/d_{\rm{CH}}$. The rigid coupling $d_{\rm{CH}}$ used was 22 kHz.
    (D) Experimental S-DROSS curves giving signs of the order parameters measured. Grey lines are noise-only profiles.}
\end{figure}
...
%  \centering
  ...
  \caption{\label{POPGspectra}
    ...
    (C) Headgroup and glycerol backbone R-PDLF dipolar slices. The arrows indicate the splittings used to determine the C--H bond order parameters by using  $|S_{\rm{CH}}|=\Delta\nu/0.315/d_{\rm{CH}}$. The rigid coupling $d_{\rm{CH}}$ used was 22 kHz.
    (D) Experimental S-DROSS curves giving signs of the order parameters measured. Grey lines are a set of slices taken from a region of the spectrum without peaks, i.e. grey lines are noise profiles, to highlight the signal-to-noise ratio of the measured modulations. Note that the S-DROSS modulation for $g_3$ is very close to the noise level. In this case, we have confirmed that the order parameter sign of $g_3$ was negative by performing a measurement with less points in the indirect dimension, more scans and using a higher MAS frequency of 8 kHz. 
  }
\end{figure}
...
%    \begin{tabular}{l c c r r r r r r c c}
    \begin{tabular}{l c r r r r r c c}
      ...
      POPE & CHARMM36 \cite{klauda10}           %&0       
      		& 144	& 5760  %&0    
		& 310  & 500          & 400          & \cite{charmm36POPEfiles} \\
      POPE & CHARMM36 \cite{klauda10}           %& 0      
      		& 500       & 25000 %& 0   
		&  310  & 500 & 100 & \cite{POPEcharmm} \\
%   POPE	& CHARMM36 \cite{klauda10}           %& 0.11
%		& 500       & 25000 & 50  &  310  & 500 & 100 & \cite{POPEcharmm150mMNaCl} \\
      POPE	& CHARMM36-UA \cite{??}         %&0       
      		& 336	& 15254 %&0    
		& 310  & 2$\times$200 & 2$\times$100 & \cite{charmm36uaPOPEfiles}  \\
      \hline
      DPPE	& Slipids \cite{jambeck12b}    %&0    
      		& 288 	& 9386  %&0    
		& 336  & 200 & 100 & \cite{slipidsDPPEfiles}  \\
      POPE	& Slipids \cite{jambeck12b} %&0    
      		& 336	& ?     %&0    
		& 310  & 2$\times$200 &  2$\times$100 & \cite{slipidsPOPEfiles}  \\
      POPE	& Slipids \cite{jambeck12b}            %& 0
		& 500 & 25000 %& 0   
		&  310  & 500 & 100 & \cite{POPEslipids} \\
...
%		& 500 & 25000 & 50  &  310  & 500 & 100 & \cite{POPEslipids150mMNaCl} \\
      ...
      DPPE	& GROMOS-CKP    \cite{??}      %&0
          	& 128	& 3655  %&0    
		& 342  & 2$\times$500 & 2$\times$400 & \cite{gromosCKPdppe} \\
%      POPE  & GROMOS-CKP    \cite{??}      %&0
%    		& 128	& 3552  &0    & 313  & 2$\times$500 & 2$\times$400 & \cite{gromosCKPpope} \\
      POPE	& GROMOS-CKP    \cite{??}      %&0
          	& 500	& 25000 %&0    
		& 310  & 500 & 100 & \cite{gromosCKPpopeT310} \\
...
%      DOPE  & GROMOS-CKP    \cite{??}      &0    & 128	& 4789  &0    & 271  & 2$\times$500 & 2$\times$400 & \cite{gromosCKPdope} \\
      ...
      POPE	& GROMOS 43A1-S3 \cite{??}     %&0
          	& 128	& 3552     %&0    
		& 313  & 2$\times$200 & 2$\times$100 & \cite{gromos43a1s3POPEfiles}  \\
      \hline
      POPE	& OPLS-UA/HG-H \cite{??}   %&0    
      		& 128	& 3328     %&0    
		& 303  & 2$\times$200 & 2$\times$100 & \cite{OPLSuaWvdWPOPEfiles} \\
      POPE	& OPLS-UA \cite{??}            %&0
      		& 128	& 3328     %&0    
		& 303  & 2$\times$200 & 2$\times$100 & \cite{OPLSuaPOPEfiles} \\
      \hline
      POPE	& OPLS-MacRog \cite{rog16}     %&0    
      		& 144	& 5760     %&0    
		& 310  & 500 & 350 & \cite{MacRogPOPEfiles} \\
%   POPE	& OPLS-MacRog \cite{rog16}     &0    & 128	& 5120     &0    & 300  & 500 & 300 & \cite{MacRogPOPEfilesT300K} \\
      \hline
      POPE	& Berger-POPE-2004 \cite{??}       %&0    
      		& 128	& 3552  %&0    
		& 303  & 2$\times$200 & 2$\times$100 & \cite{bergerPOPEfiles}  \\
      POPE	& Berger-POPE-2018 \cite{??}      %&0    
      		& 128	& 3552  %&0    
		& 303  & 2$\times$200 & 2$\times$100 & \cite{berger2POPEfiles}  \\
...
%      POPE             & Lipid17 \cite{gould18} & 0.11   & 500 & 25000 & 50  &  310  & 500 & 100 & \cite{POPElipid17150mMNaCl} \\
  ...
  \todo{Citation for GROMOS-CKP POPE AND POPG  http://pubs.acs.org/doi/abs/10.1021/jp207013v  } \\
...
%  \end{sidewaystable*} 
  ...
  \resizebox{\columnwidth}{!}{
    \begin{tabular}{l c c r r r r r r c c}
      ...
      \hline
      POPG/K$^+$  & CHARMM36 \cite{venable13}       &0         & 118& 4110   &0    & 298  & 100 & 100 & \cite{CHARMM36popg}  \\
%      POPG             & CHARMM36 \cite{venable13}        & 0.11           & 500 & 25000 & 49  &  310  & 500 & 100 & \cite{POPGcharmm150mMNaCl} \\
      POPG             & CHARMM36 \cite{venable13}        & 0              & 500 & 25000 & 0   &  310  & 500 & 100 & \cite{POPGcharmm} \\
      \hline
...
%      POPC:POPG (7:3)        & CHARMM36 \cite{??}        & 0.11      & 0  & 350     & ?     & ?   &  310  & 500 & 100 & \cite{POPC7POPG1charmm36NaCl}  \\
      POPC                   & CHARMM36 \cite{klauda10}        & 0         & 0  & 500     & 25000 & 0   &  310  & 500 & 100 & \cite{POPCcharmmT310K}  \\
      POPC:POPG (7:3)        & CHARMM36 \cite{klauda10,venable13}        & 0         & 0  & 350     & 25000 & 0   &  310  & 500 & 100 & \cite{POPC7POPG1charmm36}  \\
      POPC:POPG (1:1)        & CHARMM36 \cite{klauda10,venable13}        &0          & 0  & 150:150 & 31500 & 0   &  298  & 500 & 400 & \cite{CHARMM36POPCPOPG5050} \\ 
      POPC:POPG (1:1)        & CHARMM36 \cite{klauda10,venable13}        &0          & 0.1 & 150:150 & 31329 & 57 &  298  & 400 & 300 & \cite{CHARMM36POPCPOPG5050100mMCaCl} \\
      POPC:POPG (1:1)        & CHARMM36 \cite{klauda10,venable13}        &0          & 1.08 & 150:150 & 29766 & 578  &  298  & 500 & 400 & \cite{CHARMM36POPCPOPG50501000mMCaCl} \\
  ...
  \end{minipage}
    ...
    \todo{Citation and ion model for GROMOS-CKP POPC https://pubs.acs.org/doi/abs/10.1021/ct3003157 } \\
\end{table*}
%\end{sidewaystable*}
...
%\noindent {\it POPG with additional NaCl} \todo{Simulation details by A. Peon.} A pure POPG system was built with CHARMM-GUI Membrane builder [https://doi.org/10.1021/acs.jctc.5b00935]. A symmetric lipid distribution was used. The bilayer contains 500 lipids and 50 CHARMM TIP3P Water model per lipid. The simulated system was minimized, equilibrated and production run. The production simulation was 500-ns-long, which the last 100 ns were analysed.
For production simulation, a Leap-Frog algorithm was applied for integrating Newton’s equations of motion, and the LINCS algorithm was used to constrain all covalent bonds, allowing a time step of 2 fs. For water, the SETTLE method was applied. The simulation was performed in the NPT ensemble where the temperature was kept constant with the V-rescale thermostat (JCP 126, 014101, https://doi.org/10.1063/1.2408420) with water together with eventual ions and lipids coupled to separate thermostats with a coupling constant of 0.1 ps. The pressure was kept constant with a semi-isotropic scheme. The Parrinello–Rahman barostat was used to keep the pressure at 1 bar with a coupling constant of 1 ps and a compressibility of 4.6 × 10–5 bar–1. Long-range electrostatic interactions with a real-space cutoff of 1.0 nm were treated by a particle mesh Ewald scheme (PME) with a Fourier spacing of 0.12 nm and a fourth-order interpolation to the Ewald mesh. van der Waals interactions were treated with a Lennard-Jones (LJ) potential with a cutoff of 1.0 nm. Long-range dispersion correction to the pressure and energy was added.

\noindent {\it POPC:POPE mixtures} Data is available at \cite{POPCcharmm300K,POPC1POPE1charmm36}.
A pure POPC system and a 50:50 POPC:POPE mixture were built and equilibrated using CHARMM-GUI [https://doi.org/10.1021/acs.jctc.5b00935].
...
The simulations were run with the GROMACS 2016.4 [https://doi.org/10.1016/j.softx.2015.06.001] version.
The v-rescale thermostat [http://dx.doi.org/10.1063/1.2408420] was used with a temperature of 300 K and a time constant of 1 ps; lipids and water were coupled separately to the heat bath.
Pressure was kept constant at 1 bar using a semi-isotropic Parrinello--Rahman barostat [https://doi.org/10.1103/PhysRevLett.45.1196] with a time constant of 5.0 ps.
A real space cut-off of 1.2 nm was employed for electrostatic interactions while the long-range part was evaluated using the PME method [https://doi.org/10.1063/1.464397, https://doi.org/10.1063/1.470117].
A force-based switching function was used to switch the Lennard-Jones forces to zero over a range of 1--1.2 nm.
All bonds with hydrogen atoms were constrained with the LINCS algorithm [https://doi.org/10.1002/(SICI)1096-987X(199709)18:12%3C1463::AID-JCC4%3E3.0.CO;2-H].
Water molecules were kept rigid with the SETTLE algorithm [https://doi.org/10.1002/jcc.540130805].
The simulation files are available from ref 64 [https://doi.org/10.5281/zenodo.1306800] (pure POPC) and 65 [https://doi.org/10.5281/zenodo.1306821] (POPC:POPE mixture).
...
\noindent {\it POPC and POPC:POPG (7:3) mixture} \todo{Simulation details by A. Peon.} A pure POPC and POPC:POPG (7:3) mixture were built with CHARMM-GUI Membrane builder [https://doi.org/10.1021/acs.jctc.5b00935]. Bilayer contains 500 lipids and 50 CHARMM TIP3P Water model per lipid. All simulated systems were minimized, equilibrated and production run. Production simulations were 500-ns-long, which the last 100 ns were analysed.
...
The Slipids force field \cite{jambeck12,jambeck12b,jambeck13} was used for lipids, and the TIP3P model \cite{jorgensen1983comparison} for water. A 300~ns-long simulation was performed using GROMACS 2019.4 \cite{abraham2015gromacs}. The simulation parameters were equal to those used for the POPC/POPG mixture with additional CaCl$_2$ (see below). 
...
\noindent {\it POPC:POPE mixtures} Data is available at \cite{POPCberger300K,POPC1POPE1berger}. 
Two systems were simulated using the Berger force field [https://doi.org/10.1016/S0006-3495(97)78845-3], pure POPC and a mixture 50:50 POPC:POPE. For POPE, we additionnally used the de Vries modification implementing a repulsion of the hydrogen atoms located on the amino group of ethanolamine [https://doi.org/10.1021/jp0366926].
Starting from a PDB file of a pure POPC system with Berger atom names, a 50:50 POPC:POPE mixture was built by mutating randomly methyl groups to hydrogens (POPC -> POPE). Each system contained 256 lipids (for the mixture 64 lipids per leaflet for each species) and about 40 water molecules per lipid. No ions were added. Both systems were minimized and equilibrated. The production simulations were run for 300 ns with a time step of 2 fs. The first 100 ns were discarded for the analysis (@Samuli: this sentence may be removed if the analysis was done on a different time window). The simulations were run with GROMACS 4.5.3 [https://doi.org/10.1093/bioinformatics/btt055] version. The v-rescale thermostat [http://dx.doi.org/10.1063/1.2408420] was used with a temperature of 300 K and a time constant of 0.1 ps; lipids and water were coupled separately to the heat bath. Pressure was kept constant at 1 bar using a semi–isotropic Parrinello–Rahman barostat [https://doi.org/10.1103/PhysRevLett.45.1196] with a time constant of 4.0 ps. A real space cut-off of 1.0 nm was employed for van der Waals and electrostatic interactions. The long-range part of electrostatic interactions was evaluated using the PME method [https://doi.org/10.1063/1.464397, https://doi.org/10.1063/1.470117] with a grid spacing of 0.12 nm and an interpolation order of 4. All bonds with hydrogen atoms were constrained with the LINCS algorithm [https://doi.org/10.1002/(SICI)1096-987X(199709)18:12%3C1463::AID-JCC4%3E3.0.CO;2-H]. Water molecules were kept rigid with the SETTLE algorithm [https://doi.org/10.1002/jcc.540130805]. The simulation files are available from ref 91 [https://doi.org/10.5281/zenodo.1402417] (pure POPC) and 92 [https://doi.org/10.5281/zenodo.1402449] (POPC:POPE mixture).
...
A pure POPE system was built with CHARMM-GUI Membrane builder [https://doi.org/10.1021/acs.jctc.5b00935]. A symmetric lipid distribution was used. The bilayer contains 500 lipids and 50 SPC Water model per lipid. GROMOS-CKP force field was used for lipid and GROMOS54A7 for the rest. The simulated system was minimized, equilibrated and production run. The production simulation was 500-ns-long, which the last 100 ns were analysed.
For production simulation, a Leap-Frog algorithm was applied for integrating Newton’s equations of motion, and the LINCS algorithm was used to constrain all covalent bonds, allowing a time step of 2 fs. For water, the SETTLE method was applied. The simulation was performed in the NPT ensemble where the temperature was kept constant with the V-rescale thermostat (JCP 126, 014101, https://doi.org/10.1063/1.2408420) with water together with eventual ions and lipids coupled to separate thermostats with a coupling constant of 0.1 ps. The pressure was kept constant with a semi-isotropic scheme. The Parrinello–Rahman barostat was used to keep the pressure at 1 bar with a coupling constant of 1 ps and a compressibility of 4.6 × 10–5 bar–1. Long-range electrostatic interactions with a real-space cutoff of 1.0 nm were treated by a particle mesh Ewald scheme (PME) with a Fourier spacing of 0.12 nm and a fourth-order interpolation to the Ewald mesh. van der Waals interactions were treated with a Lennard-Jones (LJ) potential with a cutoff of 1.0 nm. Long-range dispersion correction to the pressure and energy was added.
...
A pure L-POPG system was built with CHARMM-GUI Membrane builder [https://doi.org/10.1021/acs.jctc.5b00935]. A symmetric lipid distribution was used. The bilayer contains 500 lipids (http://pubs.acs.org/doi/abs/10.1021/jp207013v) and 50 SPC Water model per lipid with 500 sodium ions. GROMOS-CKP force field was used for lipid and GROMOS54A7 for the rest. The simulated system was minimized, equilibrated and production run. The production simulation was 500-ns-long, which the last 100 ns were analysed.
For production simulation, a Leap-Frog algorithm was applied for integrating Newton’s equations of motion, and the LINCS algorithm was used to constrain all covalent bonds, allowing a time step of 2 fs. For water, the SETTLE method was applied. The simulation was performed in the NPT ensemble where the temperature was kept constant with the V-rescale thermostat (JCP 126, 014101, https://doi.org/10.1063/1.2408420) with water together with eventual ions and lipids coupled to separate thermostats with a coupling constant of 0.1 ps. The pressure was kept constant with a semi-isotropic scheme. The Parrinello–Rahman barostat was used to keep the pressure at 1 bar with a coupling constant of 1 ps and a compressibility of 4.6 × 10–5 bar–1. Long-range electrostatic interactions with a real-space cutoff of 1.0 nm were treated by a particle mesh Ewald scheme (PME) with a Fourier spacing of 0.12 nm and a fourth-order interpolation to the Ewald mesh. van der Waals interactions were treated with a Lennard-Jones (LJ) potential with a cutoff of 1.0 nm. Long-range dispersion correction to the pressure and energy was added.
...
Force field details
Simulations of POPC:POPE mixtures using the OPLS-MacRog force field [https://doi.org/10.1021/jp5016627] were performed. 
The initial force field parameter files in GROMACS format were taken from ref [https://doi.org/10.1016/j.dib.2016.03.067]. 
...
we thus added back those impropers. The resulting fixed files can be found on 
Zenodo (https://zenodo.org/record/3741793/files/popc\_fixed.itp, https://zenodo.org/record/3725637/files/pope\_fixed.itp). 
To check our fix, one simulation of pure POPC was also run and the order parameter compared to previous published results 
of ref [https://doi.org/10.1021/acs.jpcb.5b04878]. We found very similar values.
All the details of the procedure described here are described 
in https://www.dsimb.inserm.fr/~fuchs/project\_Samuli/POPC\_POPE/report\_results\_comparison.pdf.

The data for pure POPC are available from [https://zenodo.org/record/3741793], for the POPC:POPE mixture from [https://zenodo.org/record/3725637].

Simulation details
Two systems of pure POPC and 50:50 POPC:POPE mixture were built using CHARMM-GUI [https://doi.org/10.1021/acs.jctc.5b00935]. They contained 128 lipids and 5120 TIP3 water molecules. The initial PDB file was modified to match OPLS-MacRog nomenclature and atom order. No ions were added. The production simulations were run for 500 ns with a time step of 2 fs. The first 200 ns were discarded for the analysis (@Samuli: this sentence may be removed if the analysis was done on a different time window). The simulations were run withthe GROMACS 2018.5 [https://doi.org/10.1016/j.softx.2015.06.001] version. The v-rescale thermostat [http://dx.doi.org/10.1063/1.2408420] was used with a temperature of 300 K and a time constant of 0.1 ps; lipids and water were coupled separately to the heat bath. Pressure was kept constant at 1 bar using a semi–isotropic Parrinello–Rahman barostat [https://doi.org/10.1103/PhysRevLett.45.1196] with a time constant of 4.0 ps. Long-range electrostatic interactions were calculated using the PME method [https://doi.org/10.1063/1.464397, https://doi.org/10.1063/1.470117]. A real space cut-off of 1.0 nm was employed with a grid spacing of 0.1 nm in the reciprocal space. Lennard-Jones potentials were cut off at 1.0 nm. All covalent bonds in lipids were constrained using the LINCS algorithm [https://doi.org/10.1002/(SICI)1096-987X(199709)18:12%3C1463::AID-JCC4%3E3.0.CO;2-H]. Water molecules were kept rigid with the SETTLE algorithm [https://doi.org/10.1002/jcc.540130805]. The simulation files are available from ref 66 [https://doi.org/10.5281/zenodo.3741793] (pure POPC) and 67 [https://doi.org/10.5281/zenodo.3725637] (POPC:POPE mixture).


\subsection{Lipid17}

\noindent {\it POPE} \todo{Simulation details by A. Peon.}
From a pure POPE system built with CHARMM-GUI was used to create the Amber input files. Amber prmtop and inpcrd files were obtained with LEaP from AmberTools 16 distribution (http://ambermd.org/). Then, in order to create the Gromacs input files, ParmEd (v 3.0.0, Swails J. ParmEd [Internet]. https://github.com/ParmEd/ParmEd; https://dx.doi.org/10.1007/s10822-016-9977-1) was used to convert the Amber prmtop and inpcrd files into Gromacs top and gro files. 
The bilayer contains 500 lipids and 50 TIP3P waters per lipid. The simulated system was minimized, equilibrated and production run. Production simulation was 500-ns-long, which the last 100 ns were analysed.
For production simulation, a Leap-Frog algorithm was applied for integrating Newton’s equations of motion, and the LINCS algorithm was used to constrain all covalent bonds, allowing a time step of 2 fs. For water, the SETTLE method was applied. The simulation was performed in the NPT ensemble where the temperature was kept constant with the V-rescale thermostat (JCP 126, 014101, https://doi.org/10.1063/1.2408420) with water together with eventual ions and lipids coupled to separate thermostats with a coupling constant of 0.1 ps. The pressure was kept constant with a semi-isotropic scheme. The Parrinello–Rahman barostat was used to keep the pressure at 1 bar with a coupling constant of 1 ps and a compressibility of 4.6 × 10–5 bar–1. Long-range electrostatic interactions with a real-space cutoff of 1.0 nm were treated by a particle mesh Ewald scheme (PME) with a Fourier spacing of 0.12 nm and a fourth-order interpolation to the Ewald mesh. van der Waals interactions were treated with a Lennard-Jones (LJ) potential with a cutoff of 1.0 nm. Long-range dispersion correction to the pressure and energy was added.

\noindent {\it POPG} \todo{Simulation details by A. Peon.}
From a pure POPG system built with CHARMM-GUI was used to create the Amber input files. Amber prmtop and inpcrd files were obtained with LEaP from AmberTools 16 distribution (http://ambermd.org/). Then, in order to create the Gromacs input files, ParmEd (v 3.0.0, Swails J. ParmEd [Internet]. https://github.com/ParmEd/ParmEd; https://dx.doi.org/10.1007/s10822-016-9977-1) was used to convert the Amber prmtop and inpcrd files into Gromacs top and gro files. 
...
\noindent
{\it Am{\'e}lie Bacle} Am{\'e}lie Bacle set up, performed and analysed POPC and POPC:POPE (1:1) simulations with the Berger Force Field.
...
\noindent
{\it Fernando Favela-Rosales} set up and performed DPPE, POPG and DPPG simulations with the Slipids Force Field.
%% Please write description of your contribution here
